...
(ce32k/sparse acceptance from run onj1sptp's wandb summary; its
accepted-per-verify/full-block/parity columns were in the box-local CSV
that did not survive the archive — acceptance is the durable value.)
